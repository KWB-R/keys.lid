...
performances_lid <- performances %>%  
  ...
  dplyr::mutate(percent_lid_area = percent_lid_area, 
                vrr_perpercent_catchment = vrr/(percent_lid_area/100), 
  ...
  dplyr::summarize(vrr_perpercent_catchment_median = median(.data$vrr_perpercent_catchment),
                   vrr_perpercent_catchment_sd = sd(.data$vrr_perpercent_catchment),
                   vrr_median = median(.data$vrr), 
                   vrr_sd = sd(.data$vrr),     
                   ...
                   vrr_diff_perpercent_catchment_median = median(.data$vrr_diff_perpercent_catchment),
                   vrr_diff_perpercent_catchment_sd = sd(.data$vrr_diff_perpercent_catchment)
                   ) %>% 
  dplyr::arrange(dplyr::desc(.data$vrr_perpercent_catchment_median))
}
...
lid_50percent_table_by_zone %>% 
  ...
  ggplot2::labs(title = sprintf("Klimazone %s", climate_zone_id),
                y = "J\u00E4hrlicher Regenr\u00FCckhaltanstieg je Prozent LID-Fl\u00E4chenanteil im Einzugsgebiet",
                x = "Designszenario",
                fill = "LID") +
  ggplot2::theme_bw() +
  ggplot2::theme(legend.position="top")
