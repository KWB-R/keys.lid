...
keys.lid::boxplot_vrr(lid = "bioretention_cell", zone_id = 3)
...
keys.lid::boxplot_vrr(lid = "bioretention_cell", zone_id = 5)
...
keys.lid::boxplot_vrr(lid = "permeable_pavement", zone_id = 3)
...
keys.lid::boxplot_vrr(lid = "permeable_pavement", zone_id = 5)
